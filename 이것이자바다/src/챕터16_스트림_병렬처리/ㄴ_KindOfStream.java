...
public class ㄴ_KindOfStream {
	...
	// BaseStream 인터페이스에는 모든 스트림에서 사용할 수 있는 공통 메소드들이 정의되어 있을 뿐 코드에서 직접억으로 사용되지는 않는다.
	...
	// 다음 예제는 List<Student> 컬렉션에서 Stream<Student>를 얻어내고 요소를 콘솔에 출력한다.
			...
			//	Getting Stream From Arrays
	
	// 다음 예제는 String[]과 int[] 배열로부터 스트림을 얻어내고 콘솔에 출력한다.
	
			//	Getting Stream From Number Range
